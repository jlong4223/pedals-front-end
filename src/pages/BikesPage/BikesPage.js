            ...
            <div className="bikesCard">
                <div className="flip-card-inner">
                    ...
                    <div className="flip-card-back">
                        <h2>Details</h2>
                        <h3>{props.bikes.brand} {props.bikes.name}</h3>
                        <h5>Last day available: {props.bikes.availableTill}</h5>
                        <h5><i className="fas fa-dollar-sign"></i>: $30/day</h5>
                        <h5><i className="fas fa-address-book fa-lg"></i> <em>{props.bikes.contact}</em></h5>
                    </div>
                </div>
            </div>
        </div>
